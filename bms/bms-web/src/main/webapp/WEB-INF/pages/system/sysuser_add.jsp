                                                ...
                                                <tr>
                                                    <c:forEach items="${list}" var="role">
                                                        <td>
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="radio" name="roleId" value="${role.id}"  <c:if test="${role.id == user.roleId}" >checked="checked"</c:if>/>${role.name}
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </c:forEach>
                                                ...
                                                <tr>
                                                    <c:forEach items="${list}" var="role">
                                                        <td>
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="radio" name="roleId" value="${role.id}" checked="checked"/>${role.name}
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </c:forEach>
