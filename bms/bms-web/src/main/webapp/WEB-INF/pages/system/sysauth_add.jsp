                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="/sysauth/add" method="post" data-parsley-validate="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" name="text" value="${auth.text}" placeholder="请输入菜单名称"  data-parsley-required="true" data-parsley-required-message="菜单名称不能为空">
                                    </div>
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="/sysauth/add" method="post" data-parsley-validate="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" name="text" value="${auth.text}" placeholder="请输入按钮名称"  data-parsley-required="true" data-parsley-required-message="按钮名称不能为空">
                                    </div>
